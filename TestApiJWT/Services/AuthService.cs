...
namespace TestApiJWT.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<AuthModel> GetTokenAsync(TokenRequestModel model)
        {
            ...
            if (_userManager.FindByEmailAsync(model.Email) == null || !await _userManager.CheckPasswordAsync(user, model.Password))
            {
        ...
        public async Task<string> AddRoleAsync(RoleModel model)
        {
            ...
            if (await _userManager.IsInRoleAsync(user, model.RoleName))
                return "The user is already asign to this role";
